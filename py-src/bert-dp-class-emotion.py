...
df_train_syn = pd.read_csv(f"{SYN_DATA_DIR}/e8_epocs4_dp_train_16k.csv", delimiter=",")
...
for batch in test_dataloader:
    ...
    eval_mcc_accuracy += tmp_eval_mcc_accuracy
    nb_eval_steps += 1
print(f"\n\t e=8 epocs=4 Test Accuracy: {eval_accuracy/nb_eval_steps}")
print(f"\n\t e=8 epocs=4 Test MCC Accuracy: {eval_mcc_accuracy/nb_eval_steps}")
